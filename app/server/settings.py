...
SECRET_KEY = os.getenv("SECRET_KEY", "django-insecure-!r=koo!(z86)c86*z_xh@m!cl5sn8js(#a$l9%9$chntk@mogl")
...
REST_FRAMEWORK = {
    ...
    "PAGE_SIZE": 9,  # количество элементов на странице по умолчанию
}
